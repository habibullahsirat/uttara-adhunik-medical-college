...
if (about.length === 0) {
return ( <div className="text-center py-12 bg-gray-50 rounded-lg"> <p className="text-gray-500 text-lg">
No PDF document found. Add your first PDF document. </p> </div>
);
}
...
{!pdfErrors[item._id] && item.pdfUrl ? ( <div className="flex flex-col items-center justify-center">
{/* PDF Icon */} <div className="flex items-center justify-center w-20 h-20 rounded-xl bg-red-100"> <svg
